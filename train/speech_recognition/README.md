...
**DISCLAIMER: THESE FILES HAVE BEEN PROVIDED FROM THE TENSORFLOW REPOSITORY ON [GITHUB](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/lite/micro/examples/micro_speech/train) **
